...
public class AuthController {
     ...
     */
    @GetMapping("verify")
    public ResponseEntity<UserInfo> verifyUser(@CookieValue("HS-TOKEN") String token,
                                               HttpServletRequest request,
                                               HttpServletResponse response){
        try {
            // 从token中解析token信息
