package com.hopeshop.user.service;

import com.hopeshop.common.util.Md5Utils;
import com.hopeshop.common.util.NumberUtils;
import com.hopeshop.pojo.User;
import com.hopeshop.user.mapper.UserMapper;
...
public class UserService {
    ...
    public Boolean sendVerifyCode(String phone) {
        ...
        try {
            ...
            msg.put("phone", phone);
            msg.put("code", code);
            this.amqpTemplate.convertAndSend("hopeshop.sms.exchange", "sms.verify.code", msg);
            // 将code存入redis
